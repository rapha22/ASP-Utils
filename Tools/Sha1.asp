<script type="text/javascript" language="jscript" runat="server">
	...
	(function ()
	{
		...
		//NOTA KmV: Apesar de já existir um componente para UTF-8 dentro de "Tools", optei por preservar o código deste
		//arquivo o máximo possível, por isso mantive esta implementação "redundante".
